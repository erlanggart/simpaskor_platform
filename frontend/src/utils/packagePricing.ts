...
export const REVENUE_SHARE_LABEL = "Negosiasi dengan admin";
export const REVENUE_SHARE_SHORT_LABEL = "Negosiasi";
export const BUNDLE_PLATFORM_SHARE_PERCENT = 25;
export const BUNDLE_ORGANIZER_SHARE_PERCENT = 75;
export const BUNDLE_REVENUE_SHARE_LABEL = REVENUE_SHARE_LABEL;
export const BUNDLE_REVENUE_SHARE_SHORT_LABEL = REVENUE_SHARE_SHORT_LABEL;
