...
const LandingPage: React.FC = () => {
	...
	const stats = [
		...
		},
		{
			...
			label: "TOTAL EVENT",
			icon: TrophyIcon,
			iconClassName: "w-9 h-9 sm:w-11 sm:h-11 scale-125",
		},
	];
	...
	return (
		...
		<div className="landing-page relative h-full">
			...
			<a
				...
				className={`fixed right-6 md:right-auto md:left-6 md:bottom-6 z-50 w-14 h-14 rounded-full bg-white dark:bg-gray-900 shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-[0_0_20px_rgba(37,211,102,0.5)] active:scale-95 wa-float-btn${isIPhone ? " wa-float-btn--iphone" : ""}`}
				aria-label="Hubungi Admin via WhatsApp"
			>
				<Lottie
					animationData={headphoneAnimation}
					loop
					autoplay
