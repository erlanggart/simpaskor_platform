					...
					<div className="lg:col-span-2">
						...
						{assignment.assignedCategories && assignment.assignedCategories.length > 0 && (
							<div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
								...
								{assignment.assignedCategories.some(cat => cat.assessmentCategory.description) && (
									<div className="mt-4 space-y-2">
										{assignment.assignedCategories
											.filter(cat => cat.assessmentCategory.description)
											.map((cat) => (
												<div key={cat.id} className="text-sm text-gray-600 dark:text-gray-400">
													<span className="font-medium">{cat.assessmentCategory.name}:</span>{" "}
