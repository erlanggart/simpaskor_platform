...
const OrderManagement: React.FC = () => {
	...
	const getStatusColor = (status: string) => {
		const colors: Record<string, string> = {
			...
			PROCESSING: "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400",
				...
				<div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => setSelectedOrder(null)}>
					...
					>
						...
						<div className="p-6 space-y-4">
							...
							{/* Total */}
							<div className="flex justify-between items-center pt-2 border-t border-gray-200/60 dark:border-gray-700/40">
										...
										<button
											...
											className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
												selectedOrder.status === status
													? getStatusColor(status) + " ring-2 ring-offset-1 ring-red-500"
