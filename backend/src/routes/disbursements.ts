		...
		try {
			...
			res.json({
				...
				summary: {
					...
					lockedPlatformShare: ledgerSummary.lockedPlatformShare,
					activePlatformShare: ledgerSummary.activePlatformShare,
				...
				return {
					...
					eventBalance: balance
						? {
								...
								lockedPlatformShare: balance.lockedPlatformShare,
								activePlatformShare: balance.activePlatformShare,
